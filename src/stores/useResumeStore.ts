    ...
    skills: [
      ...
      },
      {
        ...
        children: [
          ...
          { name: 'DHCP', value: 1 },
          { name: 'DNS', value: 1 },
          { name: 'LAN/WAN', value: 1 },
          { name: 'TCP/IP', value: 1 },
          { name: 'HTTP/HTTPS', value: 1 },
          { name: 'SMTP', value: 1 },
          { name: 'SSL/TLS', value: 1 },
          { name: 'Firewall', value: 1 },
          { name: 'Port Forwarding', value: 1 },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          { name: 'SCCM', value: 1 },
          { name: 'AnyDesk', value: 1 },
          { name: 'CRM', value: 1 },
          { name: 'Jenkins', value: 1 },
          { name: 'GitLab CI/CD', value: 1 },
          { name: 'Docker', value: 1 },
          { name: 'Kafka', value: 1 },
          { name: 'Spark', value: 1 },
        ],
      ...
      },
      {
        ...
        children: [
          { name: 'Python', value: 1 },
          { name: 'Excel Macros', value: 1 },
          { name: 'BeautifulSoup', value: 1 },
          { name: 'Playwright', value: 1 },
      ...
      },
      {
        name: 'Administration',
        children: [
          { name: 'MS Exchange', value: 1 },
          { name: 'Active Directory', value: 1 },
          { name: 'Office Suite', value: 1 },
          { name: 'IIS', value: 1 },
          { name: 'Service Desk Tools', value: 1 },
          { name: 'SLA Management', value: 1 },
          { name: 'Workforce Planning', value: 1 },
        ],
      },
      {
        name: 'Soft Skills',
        children: [
          ...
          { name: 'Troubleshooting', value: 1 },
          { name: 'ITIL', value: 1 },
          { name: 'Management', value: 1 },
          { name: 'Stakeholder Communication', value: 1 },
      ...
      },
      {
        name: 'Other Tech',
        children: [
          { name: 'SEO Optimization', value: 1 },
          { name: 'Web Scraping', value: 1 },
          { name: 'Crypto Trading Bots', value: 1 },
          { name: 'Machine Learning', value: 1 },
          { name: 'Data Visualization', value: 1 },
          { name: 'Workflow Automation', value: 1 },
